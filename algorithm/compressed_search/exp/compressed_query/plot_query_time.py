...
df = pd.read_csv('D:\\2025\\DQ\\research\\compressed_search\\compressed_search\\exp\\compressed_query\\time_query_time.csv', header=None)  # 没有标题行
...
ax.set_title('Compression Prediction Search Time')
ax.set_yscale('log')
ax.legend(ncol=7, loc='upper center')
plt.tight_layout()
plt.savefig('D:\\2025\\DQ\\research\\compressed_search\\compressed_search\\exp\\compressed_query\\time_prediction_query.png')