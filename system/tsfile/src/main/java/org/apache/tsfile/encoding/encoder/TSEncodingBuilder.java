...
public abstract class TSEncodingBuilder {
  ...
  public static class Predict extends TSEncodingBuilder {
    @Override
    public Encoder getEncoder(TSDataType type) {
      switch (type) {
        case INT64:
        case TIMESTAMP:
          return new LongPredictEncoder(TSEncoding.PREDICT);
        default:
          throw new UnSupportedDataTypeException("PREDICT doesn't support data type: " + type);
      }
    }
